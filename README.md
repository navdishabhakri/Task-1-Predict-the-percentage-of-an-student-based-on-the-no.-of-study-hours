...
* The Mean absolute error came to 3.92. A small value of mean absolute error states that the chances of error or wrong forecasting through the model are very less.
